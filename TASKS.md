...
| 8.7 | **Écrire** (UI) | 🟢 libre | ⛔ Publier ET lire conditionnés à `legalIsComplete()` — **`LEGAL_CONTACT_EMAIL` n'est toujours pas dans le `.env`**, action de Tristan. Écrire dans son journal reste possible sans |
