...
| 5.10b | **A13 — les fonctionnalités film** | 🟢 libre | Le garde-fou étant posé, une entrée film ne casse plus rien. Restent : la fiche film, l'espace `tmdb-movie` côté `CatalogProvider`, et **une décision de produit** — un film doit-il compter dans le bilan d'heures ? Ça ferait passer « heures de séries » à « heures d'écran ». **Non tranché, à ne pas décider en silence** |
