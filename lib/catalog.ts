...
/** URL d'une banniere sur le CDN de TMDB. Etait fabriquee a la main dans `ChooseArtwork`. */
...
/** Dimensions a declarer : sans elles, la page saute a l'arrivee de sa plus grande image. */
