...
export const EN: Readonly<Record<keyof typeof FR, string>> = {
  ...
  'browse.genre': 'Genre',
  'browse.decade': 'Era',
  'browse.length': 'One episode lasts',
  'browse.length.short': '25 min or less',
  'browse.length.half': '26 to 45 min',
  'browse.length.long': '46 min and more',
  'browse.sort': 'Sort by',
  'browse.any': 'Any',
  ...
  'profile.block': 'Block',
  'profile.blockConfirm': 'Confirm: stop seeing each other',
  'profile.blockCancel': 'Cancel',
  'profile.blocked.title': 'You will no longer see {who}',
  'profile.blocked.body':
    'And they will no longer see you. They are not told, nothing is deleted, and the follow is removed on both sides. You can undo this whenever you want.',
  'profile.blocked.manage': 'See my blocks',
  ...
  'want.add': 'I want to watch {title}',
  'want.remove': 'Remove {title} from my watchlist',
