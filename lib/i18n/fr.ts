...
export const FR = {
  ...
  'home.browse': 'Ou parcourir par genre et par époque →',
  'browse.title': 'Parcourir',
  'browse.lede': 'Sans savoir le titre : par genre, par époque, par ce que les gens en disent.',
  'browse.genre': 'Genre',
  'browse.decade': 'Époque',
  'browse.length': 'Un épisode dure',
  'browse.length.short': '25 min ou moins',
  'browse.length.half': '26 à 45 min',
  'browse.length.long': '46 min et plus',
  'browse.sort': 'Classer par',
  'browse.any': 'Tout',
  'browse.decadeLabel': 'Années {d}',
  ...
  'browse.noneBody':
    'Le catalogue ne rend rien pour ces critères — c’est fréquent sur un genre rare croisé avec une époque proche. Élargissez l’un des deux juste au-dessus.',
  'browse.genre.action': 'Action & aventure',
  'browse.genre.animation': 'Animation',
  'browse.genre.comedy': 'Comédie',
  'browse.genre.crime': 'Policier',
  'browse.genre.documentary': 'Documentaire',
  'browse.genre.drama': 'Drame',
  'browse.genre.family': 'Famille',
  'browse.genre.kids': 'Jeunesse',
  'browse.genre.mystery': 'Mystère',
  ...
  'timeline.emptyBody':
    'Chaque geste que vous posez — une note, une position, un cœur, une critique — arrive ici avec sa date. Ouvrez une série et dites où vous en êtes.',
  'timeline.findSeries': 'Chercher une série',
  'timeline.myLibrary': 'Ma bibliothèque',
  'timeline.year': 'Année',
  'timeline.allYears': 'Toutes',
  'timeline.kind': 'Genre',
  'timeline.allKinds': 'Tout',
  'timeline.noMatchTitle': 'Rien avec ces filtres',
  'timeline.noMatchBody':
    'Aucun fait ne répond à cette combinaison. Élargissez l’année ou le genre juste au-dessus.',
  'timeline.imported': 'repris d’un import',
  'timeline.importedWhy':
    'La date affichée est celle de l’import, pas celle du visionnage : elle n’était pas dans le fichier.',
  'timeline.kind.wanted': 'Envies',
  'timeline.kind.position': 'Positions',
  'timeline.kind.ratedSeason': 'Notes de saison',
  'timeline.kind.ratedEpisode': 'Notes d’épisode',
  'timeline.kind.episodeMark': 'Épisodes sautés ou vus en avance',
  'timeline.kind.reviewed': 'Critiques',
  'timeline.kind.liked': 'Coups de cœur',
  'timeline.kind.decided': 'Décisions',
  'timeline.kind.completed': 'Visionnages achevés',
  'timeline.said.wanted': 'Ajoutée à vos envies',
  'timeline.said.liked': 'Coup de cœur',
  'timeline.said.position': 'Arrivé à la saison {s}, épisode {e}',
  'timeline.said.ratedSeason': 'Saison {s} notée {n}/5',
  'timeline.said.ratedEpisode': 'S{s}E{e} noté {n}/5',
  'timeline.said.decided': 'Décidé : {d}',
  'timeline.said.completed': 'Vue en entier',
  'timeline.said.reviewed': 'Critique écrite',
  'timeline.said.reviewedSeason': 'Critique de la saison {s}',
  'timeline.said.skipped': 'S{s}E{e} sauté',
  'timeline.said.watchedAhead': 'S{s}E{e} vu en avance',
  ...
  'want.add': 'Je veux voir {title}',
  'want.remove': 'Retirer {title} de mes envies',
